...
importers:
  ...
  nestjs-be:
    ...
    dependencies:
      ...
      '@nestjs/typeorm': 9.0.1_hkapd3a3mi37wyf4vtt5y4i2ye
      cross-env: 7.0.3
      dotenv: 16.0.3
      joi: 17.7.0
      mysql2: 2.3.3
      nest-winston: 1.8.0_xlxfmi5fzr5alofp25xqzclqqq
      reflect-metadata: 0.1.13
      rxjs: 7.8.0
      typeorm: 0.3.11_pa4ea3wjef6s4gsskhbyci3cte
      winston: 3.8.2
...
packages:
  ...
  /nest-winston/1.8.0_xlxfmi5fzr5alofp25xqzclqqq:
    resolution: {integrity: sha512-DyoNrly6DXjNG2ZPXSD2+w+pgEE8u0y0iwsaLZsufFLIKB/YNgP7zIXV5JxIqns0e5QzLlxdHhO2hx+1W8dvCw==}
    peerDependencies:
  ...
  /superagent/8.0.8:
    resolution: {integrity: sha512-OpxPrqqWKOjmuomLq5pCm4LWCSFdgAQ11XVkMl7t4ie13WxWuLkdJ83ZgG2jOQeLXKwMR2p9k30hLrKGAzkPaA==}
